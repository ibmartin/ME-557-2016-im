...
**/
int Make_Sphere(const int rows, const int segments, const float *center, const float r, float* spherePoints, float* normals, float* colors)
{
...
/*int ___main(int argc, char *argv[]) {
	...
	int number_vertices = Make_Sphere(rows, segments, center, radius, points, normals, colors);
